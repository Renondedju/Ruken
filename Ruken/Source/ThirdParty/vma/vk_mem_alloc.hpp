...
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
    VULKAN_HPP_NAMESPACE::ResultValueType<std::pair<VULKAN_HPP_NAMESPACE::Buffer, VMA_HPP_NAMESPACE::Allocation>>::type createBuffer( const VULKAN_HPP_NAMESPACE::BufferCreateInfo & bufferCreateInfo, const AllocationCreateInfo & allocationCreateInfo, VULKAN_HPP_NAMESPACE::Optional<AllocationInfo> allocationInfo = nullptr ) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/
...
#ifndef VULKAN_HPP_DISABLE_ENHANCED_MODE
    VULKAN_HPP_NAMESPACE::ResultValueType<std::pair<VULKAN_HPP_NAMESPACE::Image, VMA_HPP_NAMESPACE::Allocation>>::type createImage( const VULKAN_HPP_NAMESPACE::ImageCreateInfo & imageCreateInfo, const AllocationCreateInfo & allocationCreateInfo, VULKAN_HPP_NAMESPACE::Optional<AllocationInfo> allocationInfo = nullptr ) const;
#endif /*VULKAN_HPP_DISABLE_ENHANCED_MODE*/
...
# endif
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<std::pair<VULKAN_HPP_NAMESPACE::Buffer, VMA_HPP_NAMESPACE::Allocation>>::type Allocator::createBuffer( const VULKAN_HPP_NAMESPACE::BufferCreateInfo & bufferCreateInfo, const AllocationCreateInfo & allocationCreateInfo, VULKAN_HPP_NAMESPACE::Optional<AllocationInfo> allocationInfo ) const
  {
    ...
    std::pair<VULKAN_HPP_NAMESPACE::Buffer, VMA_HPP_NAMESPACE::Allocation> pair = std::make_pair( buffer, allocation );
  ...
  VULKAN_HPP_INLINE VULKAN_HPP_NAMESPACE::ResultValueType<std::pair<VULKAN_HPP_NAMESPACE::Image, VMA_HPP_NAMESPACE::Allocation>>::type Allocator::createImage( const VULKAN_HPP_NAMESPACE::ImageCreateInfo & imageCreateInfo, const AllocationCreateInfo & allocationCreateInfo, VULKAN_HPP_NAMESPACE::Optional<AllocationInfo> allocationInfo ) const
  {
    ...
    std::pair<VULKAN_HPP_NAMESPACE::Image, VMA_HPP_NAMESPACE::Allocation> pair = std::make_pair( image, allocation );

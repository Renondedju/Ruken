 ...
 * act as an abstraction. For example they can be used to implement different rendering
...
struct ProcessingUnit
{
    ...
    static constexpr EExecutionPolicy execution_policy {TExecutionMethod};
};

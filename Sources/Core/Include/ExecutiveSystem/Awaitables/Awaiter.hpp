...
struct Awaiter
{
	static inline auto locked   {reinterpret_cast<Awaiter* const>(0x1)};
	static inline auto consumed {reinterpret_cast<Awaiter* const>(0x2)};
	static inline auto detached {reinterpret_cast<Awaiter* const>(0x3)};

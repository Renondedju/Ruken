...
#include "Rendering/Vulkan/Core/VulkanImage.hpp"
#include "Rendering/Vulkan/Core/VulkanQueue.hpp"
...
class VulkanSwapchain
{
    private:
         ...
         * \note  The behavior is platform-dependent if the image extent does not match the surface�'s 'currentExtent'.
         */
         ...
         * \note  A swapchain�'s present mode determines how incoming present requests will be processed and queued internally.
         */
